    ...
    <footer className="bg-footer-darker text-muted-foreground">
      <div className="container py-12">
        ...
        <div className="pt-8 border-t border-border/20 text-center text-sm">
          ...
          <p className="text-xs mb-2">Website Developers: <a href="https://waptechsa.com" target="_blank" rel="noreferrer" className="text-red-600 hover:text-red-700 hover:underline">waptechsa.com / 0655253491</a></p>
          <a
            href={ADMIN_URL}
